package com.edison.excel.context;

import com.edison.excel.event.WriteHandler;
import com.edison.excel.metadata.BaseRowModel;
import com.edison.excel.metadata.ExcelHeadProperty;
import com.edison.excel.metadata.Table;
import com.edison.excel.support.ExcelTypeEnum;
import com.edison.excel.util.CollectionUtils;
import com.edison.excel.util.StyleUtil;
import com.edison.excel.util.WorkBookUtil;
...
public class WriteContext {
     ...
     * current param
     */
    private com.edison.excel.metadata.Sheet currentSheetParam;
     ...
     * @param sheet
     */
    public void currentSheet(com.edison.excel.metadata.Sheet sheet) {
    ...
    private void initCurrentSheet(com.edison.excel.metadata.Sheet sheet) {
    ...
    private void addMergedRegionToCurrentSheet(int startRow) {
        for (com.edison.excel.metadata.CellRange cellRangeModel : excelHeadProperty.getCellRangeModels()) {
    ...
    private void initTableStyle(com.edison.excel.metadata.TableStyle tableStyle) {
        if (tableStyle != null) {
    ...
    public com.edison.excel.metadata.Sheet getCurrentSheetParam() {
        return currentSheetParam;
    }

    public void setCurrentSheetParam(com.edison.excel.metadata.Sheet currentSheetParam) {
